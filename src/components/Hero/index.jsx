...
const Hero = () => {
  return (
    <>
      <section className="text-gray-600 body-font bg-[#e4edea]">
        <div className="container mx-auto flex px-5 pt-14 md:flex-row flex-col-reverse items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 text-[#444847] font-[Bungee]">
            ...
            <div className="flex justify-center">
              <a href="#contact">
                <button className="w-[80vw] flex justify-center items-center text-center md:w-full get-in-touch">
          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-row flex-wrap justify-center gap-8 text-sm font-semibold text-center text-gray-900 lg:justify-between">
              <div className="flex flex-col items-center justify-center w-36 py-6">
                <h2 className="title-font font-medium sm:text-4xl text-3xl text-[#444847]">
                  <IoLogoJavascript className="w-16 h-16 md:w-20 md:h-20 mb-2 text-[#444847]" />
                </h2>
                <p className="leading-relaxed">Javascript</p>
              </div>
              <div className="flex flex-col items-center justify-center w-36 py-6">
                <h2 className="title-font font-medium sm:text-4xl text-3xl text-[#444847]">
                  <FaReact className="w-16 h-16 md:w-20 md:h-20 mb-2 text-[#444847]" />
                </h2>
              ...
              <div className="flex flex-col items-center justify-center w-36 py-6">
                <h2 className="title-font font-medium sm:text-4xl text-3xl text-[#444847]">
                  <SiNextdotjs className="w-16 h-16 md:w-20 md:h-20 mb-2 text-[#444847]" />
                </h2>
                <p className="leading-relaxed">Next JS</p>
              </div>
              <div className="flex flex-col items-center justify-center w-36 py-6">
                <h2 className="title-font font-medium sm:text-4xl text-3xl ttext-[#444847]">
                  <TbBrandVscode className="w-16 h-16 md:w-20 md:h-20 mb-2 text-[#444847]" />
                </h2>
